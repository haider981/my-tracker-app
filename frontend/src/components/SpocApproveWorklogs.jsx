...
//         if (!user) return;
//         const token = localStorage.getItem("authToken");
//         fetch(`${API_BASE_URL}/spoc/employees`, {
...
//             setError(null);
//             const token = localStorage.getItem("authToken");
//             const res = await fetch(`${API_BASE_URL}/spoc/worklogs`, {
//                 method: "POST",
//                 headers: {
...
//             const token = localStorage.getItem("authToken");
//             const res = await fetch(`${API_BASE_URL}/spoc/worklogs/update-status`, {
//                 method: "PUT",
...
//             const res = await fetch(`${API_BASE_URL}/spoc/worklogs/bulk-update-status`, {
//                 method: "PUT",
//                 headers: { Authorization: `Bearer ${token}`, "Content-Type": "application/json" },
    ...
    return (
        ...
        <aside className="hidden lg:block fixed top-16 left-0 h-[calc(100vh-4rem)] w-72 bg-gray-800 text-white shadow-xl overflow-y-auto">
          <SidebarLinks navigate={navigate} location={location} unreadCount={unreadCount} approveMissingCount={approveMissingCount} />
                ...
                {/* ===== Main ===== */}
                <div className="flex-1 lg:ml-72 font-sans">
