...
exports.autoSubmitWorklogsAndAssignLeave = async () => {
  try {
    ...
    const allUsers = await prisma.users.findMany({
      where: {
        team: {
          // in: ["Editorial_Maths", "Editorial_Science", "Editorial_SST", "Editorial_English", "DTP_Raj", "CSMA_Maths", "CSMA_Science", "CSMA_Intern","CSMA_Technology","DTP_Suman","DTP_Naveen","CSMA_English","Animation_Maths"]
          in: ["CSMA_Intern","InternScience"]
        }
      },
      select: {
        email: true,
