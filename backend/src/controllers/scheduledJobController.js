...
exports.autoSubmitWorklogsAndAssignLeave = async () => {
  try {
    ...
    const allUsers = await prisma.users.findMany({
      where: {
        team: {
          in: ["Editorial_Maths", "Editorial_Science", "Editorial_SST", "Editorial_English", "DTP_Raj", "CSMA_Maths", "CSMA_Science", "CSMA_Intern","CSMA_Technology","DTP_Suman","DTP_Naveen","CSMA_English","Animation_Maths","Editorial_University","Editorial_Eco&Com","University_&_Titles","DTP_Rimpi","Digital_Marketing","FK_Editorial_Maths"]
        }
      },
      select: {
        email: true,
